# Generated by Django 3.2.11 on 2022-04-09 14:29
...
class Migration(migrations.Migration):
    ...
    # replaces = [('recipes', '0001_initial'), ('recipes', '0002_alter_tag_color')]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='tag',
            name='color',
            field=models.CharField(default='#569914', max_length=7, validators=[django.core.validators.RegexValidator(message='Укажите цвет в HEX кодировке.', regex='#[a-f\\d]{6}')], verbose_name='Цвет в кодировке HEX'),
        ),
    ]
